        ...
        success: function (d, r, o) {
            ...
            if (cleanEvents.length > 0){
                ...
                for(i=0;i<finalArray.length;i++){
                    ...
                    htmlContent += '<li> <a href="eventsForMuseum.html?id='+finalArray[i][0]+' "><span >' + finalArray[i][5] + ' from you</span><br /><span class="summaryOrgName" >'+finalArray[i][1]+'</span> <br /> </li></a>';
                }
